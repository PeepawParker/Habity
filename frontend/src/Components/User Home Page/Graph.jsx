...
import generateChartData from "./UserHomeFunctions/generateChartData";
import HabitDataInput from "./HabitDataInput";
import HabitDelete from "./HabitDelete";
import { useEffect, useState } from "react";
import { setHabitData } from "./UserHomeFunctions/useEffectFunctions";
import { fetchHabitData } from "../../axiosRequests/HabitData/fetchHabitData";

export default function Graph({ habit, username, setHabits }) {
    ...
    <>
      <div className="GraphBox">
        ...
        <HabitDataInput
          ...
          habitVar={habit.variable_tracked}
          userHabitId={habit.user_habit_id}
          setDataPoints={setDataPoints}
          dataPoints={dataPoints}
        />
        <HabitDelete userHabitId={habit.user_habit_id} setHabits={setHabits} />
        <div>
